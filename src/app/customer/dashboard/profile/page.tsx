                    ...
                    <div className="space-y-6">
                        ...
                        <div className="pt-6 border-t border-slate-200">
                            ...
                            <div className="space-y-3">
                                ...
                                <button className="w-full px-4 py-3 text-left rounded-xl border border-slate-200 hover:border-red-300 hover:bg-red-50 transition flex justify-between items-center group">
                                    <span className="font-medium text-slate-900 group-hover:text-red-600">
                                        Delete Account
                                    </span>
